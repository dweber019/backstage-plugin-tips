...
`backstage-plugin-tips` is [MIT licensed](LICENSE) and accepts contributions via
...
- GitHub [issues](https://github.com/dweber019/backstage-plugin-tips/issues)
...
```
git clone git@github.com:your_github_username/backstage-plugin-tips.git
cd backstage-plugin-tips
git remote add upstream https://github.com/dweber019/backstage-plugin-tips.git
git fetch upstream
```
...
[fork]: https://github.com/dweber019/backstage-plugin-tips/fork
